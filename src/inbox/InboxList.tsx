            ...
            <div className="inbox-list__container">
                {
                    result.inbox.map((channel) => (
                        <InboxListItem
                            ...
                            status={channel.id == channelIdSelected ? "selected" : channel.status}
...
const classifyReadStatus = (readDate: Dayjs, latestMessageDate: Dayjs, latestSender: string, owner: string) => {
